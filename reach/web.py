...
@bp.route("/about")
def landing():
    """Public REACH product page inside Street Banker V2.

    The working application remains at ``/reach`` and keeps its independent
    access gate. Keeping the marketing route inside the blueprint makes the
