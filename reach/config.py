...
_DEPLOYED_DATA_ROOT = os.path.join("/var", "data", "v2")
DEFAULT_DB_PATH = (
    os.path.join(_DEPLOYED_DATA_ROOT, "reach.db")
    if os.environ.get("RENDER")
    else os.path.join(_PACKAGE_ROOT, "reach.db")
)
...
PROVIDER_CREDENTIAL_ENV = {
    ...
    "reach_catalog": [],         # REACH's own catalog, always available
